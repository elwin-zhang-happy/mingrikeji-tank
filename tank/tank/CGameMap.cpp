...
void CGameMapElement::Draw(Graphics &gh)
{
    // 画空位置
    {
...
void CGameMap::LoadMap()
{
    ...
    for(int r = 0; r < m_row; ++r) {
        // 一行地图空间
        std::vector<CGameMapElement> vRow;
        // 列数据
...
// 画地图
void CGameMap::Draw(Gdiplus::Graphics &gh)
{
